...
import { createNewsArticle } from "@/lib/api";
            ...
            <div className="max-w-5xl mx-auto pt-32 px-4">
                <div className="flex items-center justify-between mb-8">
                    <div className="flex items-center gap-4">
                        ...
                        <h1 className="text-3xl font-black text-slate-900 dark:text-white font-cairo">إضافة خبر جديد</h1>
                    </div>
                    <div className="flex gap-3">
                        <button className="px-4 py-2 text-slate-600 hover:bg-slate-200 rounded-lg text-sm font-bold font-cairo">حفظ كمسودة</button>
                        <button
